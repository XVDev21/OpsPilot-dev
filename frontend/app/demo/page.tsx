...
export const metadata: Metadata = {
  ...
  description: "Try OpsPilot workflows with deterministic local results and no account.",
};
  ...
  return (
    <div className="mx-auto max-w-[86rem]">
      <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-end">
        <div>
          <Badge tone="primary">Guest demo</Badge>
      ...
      <section className="mt-8" aria-labelledby="demo-flow-heading">
        <div className="mb-3 flex items-center justify-between gap-3">
          <h2 id="demo-flow-heading" className="text-sm font-bold text-foreground">A known path for every run</h2>
